...
class PredictStore(models.Model):
    """The ABTestStart will keep information about the ab test results"""
    input_data = models.CharField(max_length=10000)
    created_by = models.CharField(max_length=128)
    created_at = models.DateTimeField(auto_now_add=True, blank=True)
    ml_algorithm = models.ForeignKey(MLAlgorithm, on_delete=models.CASCADE,
            related_name="ml_used")
